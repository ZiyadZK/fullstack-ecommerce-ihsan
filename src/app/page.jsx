      ...
      <div className="p-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <div className="space-y-5 border border-zinc-300/0 hover:border-zinc-300 ease-out duration-100 hover:shadow-lg rounded-xl p-5 cursor-pointer">
            <img src={`https://www.coca-cola.com/content/dam/onexp/id/id/brands/coca-cola/id-coca-cola.png`} className="w-full aspect-square rounded-xl object-cover object-center" alt="Foto Produk" />
